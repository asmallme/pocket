<p align="center">
  <img src="apps/web/public/icons/icon-192.png" alt="网兜" width="88" />
</p>

<h1 align="center">网兜</h1>
...
网兜想解决的就是这两件事：**让收藏这个动作变得毫不费力，让好内容因为「人的推荐」而流动起来。**
...
| **iOS 快捷指令** | Safari / X App / 多数 iOS App 可通过系统分享面板保存到网兜（在个人中心配置） |
